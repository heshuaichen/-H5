...
export default class Zhuce extends Component {
    ...
    zhuce = () => {
        ...
        if (this.state.name.length !== 11) {
            ...
            let url = "https://www.shuaishuaide.top:2004/register";
            fetch(url, {
                method: "POST",
            ...
            <div className='zc'>
                <Flex className='zc-header'>
                    <Flex style={{ width: '20rem', margin: '0 auto' }}>
                        ...
                        <Flex.Item className='zc-header-p' >注 册</Flex.Item>
                    </Flex>
                </Flex>
                ...
                <Flex style={{ width: '16rem', margin: '0 auto' }}>
                    <button className='zc-button' onClick={this.zhuce}>注册</button>
                </Flex>
            </div>
        )
    }
